    ...
    <nav class="flex flex-row items-center justify-between w-screen h-12 px-6 py-2 bg-white md:px-12">
        ...
        <div class="justify-end hidden lg:block">
            <div class="flex flex-row items-center justify-center w-full h-full space-x-6 font-digitalo">
                <a href="{{ url('/websites') }}" class="text-sm font-medium text-gray-900 uppercase lg:text-md hover:text-sky-600">
                    websites
                </a>
                <a href="{{ url('/games') }}" class="text-sm font-medium text-gray-900 uppercase lg:text-md hover:text-sky-600">
                    games
                </a>
                ...
                <a href="{{ url('/about') }}" class="text-sm font-medium text-gray-900 uppercase lg:text-md hover:text-sky-600">
                    our company
                </a>
                <a href="{{ url('/contact') }}" class="text-sm font-medium text-gray-900 uppercase lg:text-md hover:text-sky-600">
                    contact us
                </a>
            </div>
        </div>
